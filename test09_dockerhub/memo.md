...
TOKEN=$(curl -s -H "Content-Type: application/json" -X POST -d '{"username": "yimjongwon", "password": "dckr_pat_uCzZ8Pa992Yh4yKYwARX852ccBk"}' https://hub.docker.com/v2/users/login/ | jq -r .token)
